...
class SelectedItemProvider extends InheritedWidget {
  ...
  final ValueNotifier<Future<int>?> selectedMemberAttendingCount =
      ValueNotifier(null);
  final ValueNotifier<Device?> selectedDevice = ValueNotifier(null);
  final ValueNotifier<Future<File?>?> selectedMemberProfileImage =
      ValueNotifier(null);
  ...
  static SelectedItemProvider of(BuildContext context) {
    ...
    assert(provider != null,
        'There is no SelectedItemProvider in the Widget tree.');

    return provider!;
  }

  @override
  bool updateShouldNotify(SelectedItemProvider oldWidget) =>
      selectedRide != oldWidget.selectedRide &&
      selectedMember != oldWidget.selectedMember &&
      selectedDevice != oldWidget.selectedDevice;
}
