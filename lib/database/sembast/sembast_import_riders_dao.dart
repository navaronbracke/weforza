...
/// This class represents the sembast implementation of [ImportRidersDao].
class SembastImportRidersDao implements ImportRidersDao {
  SembastImportRidersDao(this._database);
