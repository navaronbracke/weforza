...
/// This class represents the sembast implementation of [ExportRidesDao].
class SembastExportRidesDao implements ExportRidesDao {
  SembastExportRidesDao(this._database);
