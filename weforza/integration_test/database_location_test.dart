...
class FakeDatabase implements Database {
  ...
  @override
  Future<T> transaction<T>(FutureOr<T> Function(Transaction transaction) action) {
    throw UnsupportedError("FakeDatabase does not support transactions. Use an in-memory database instead of a fake one.");
  }
}
...
void main(){
  ...
  */
  group("Database creation tests", (){
    ...
    testWidgets("New databases are created in the Application Support Directory", (WidgetTester tester) async {
      final testDbName = "test_database.db";
      final applicationDatabase = ApplicationDatabase(databaseName: testDbName);
